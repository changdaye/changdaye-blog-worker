...
tags:
  ...
  - Interceptor
  - 拦截器
cover: "/images/site/post-bg-mma-2.jpg"
featured: false
draft: false
---# 简介
...
1. 创建我们自己的拦截器类并实现 HandlerInterceptor 接口
   ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-11-21/6722144.jpg)

2. 创建一个Java类继承WebMvcConfigurerAdapter，并重写 addInterceptors 方法
3. 实例化我们自定义的拦截器，然后将对像手动添加到拦截器链中（在addInterceptors方法中添加）

   ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-11-21/24765173.jpg)
...
![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-11-21/46078190.jpg)
