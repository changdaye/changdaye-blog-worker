...
1. 创建一个SpringBoot - Web项目 ，pom中依赖坐标如下图所示
   ...
   ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-17/91456957.jpg)

2. 引入Swagger 依赖

   ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-17/33719682.jpg)

3. 在SpringBootStarterApplication同级目录创建Swagger配置类

   ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-17/73059632.jpg)

4. 修改配置只需要在application.properties中修改自己的配置即可。我的项目是Spring Initializr自动构建的，如你的项目不是，那配置文件名字可能是 application-XXX.yml一类的。

5. Controller中使用
   ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-17/6005778.jpg)

6. 文档效果

   ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-17/63184256.jpg)

7. 生产环境一般不会暴露接口文档出来，记得关闭开关。

   ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-17/59638105.jpg)
...
![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-17/67200541.jpg)
