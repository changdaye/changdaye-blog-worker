...
description: "很久没有写Spring Boot的内容了，正好最近在写Spring Cloud Bus的内容，因为内容会有一些相关性，所以先补一篇关于AMQP的整合。"
date: 2017-09-29
author: "Mr Chang"
tags:
  - Spring Boot
  - RabbitMQ
  - 消息队列
cover: "/images/site/post-bg-digital-native.jpg"
featured: false
draft: false
...
4. RabbitMQ Server安装完成之后，会自动的注册为服务，并以默认配置启动起来。
   ...
   ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-26/40051438.jpg)
...
2. 打开浏览器并访问：`http://localhost:15672/`，并使用默认用户`guest`登录，密码也为`guest`。我们可以看到如下图的管理页面：
   ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-26/61825965.jpg)
...
![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-10-11/92200804.jpg)
