...
2. ` yum -y install docker `
    ...
    ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-14/22748323.jpg)

3. 启动docker: `service docker start `

4. 查找nexus镜像 ： `docker search nexus`

   ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-14/93572570.jpg)
...
6. 启动nexus容器，对于以后的容器启动，[不清楚如何启动可以去docker hub 查看][https://hub.docker.com/]，
   ...
   ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-14/58578914.jpg)
    
7. 一般直接搜索`run `就可以找到如何启动

   ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-14/87774408.jpg)
    
8. 访问查看，管理员账户密码 `admin admin123`

   ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-14/45145189.jpg)
    
9. maven设置

    * setting.xml设置
      ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-14/65102103.jpg)
        
    * pom文件设置

      ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-14/12953066.jpg)
      ...
      ![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-9-14/81818372.jpg)
