...
tags:
  ...
  - 管道
  - Pipeline
cover: "/images/site/post-bg-mma-0.png"
featured: false
draft: false
---## jenkins 
...
![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-10-16/4907249.jpg)
...
![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-10-16/74146718.jpg)

如果你想每次`git commit`时自动执行该pipeline，有两种方法，一种是让Jenkins对git进行轮询，每分钟检查git仓库有没有更新，如下配置

![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-10-16/46437936.jpg)
...
![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-10-16/94290356.jpg)

设置完毕后，一旦你的git仓库收到新的提交，就会触发这个pipeline的运行，以下这张图是上面Jenkinsfile例子的运行状态，可以看到当运行到Sanity check这一步时，需要你手动触发是否执行后面的操作。

![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-10-16/63671625.jpg)
...
![](/images/posts/cdn-blog.oss-cn-beijing.aliyuncs.com/17-10-16/87249584.jpg)
